...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Ipswich Retail API',
    'DESCRIPTION': 'E-commerce API for Ipswich Retail',
    'VERSION': '1.0.0',
...
SESSION_COOKIE_DOMAIN = config('SESSION_COOKIE_DOMAIN', default=None)  # Set your domain in production
SESSION_COOKIE_PATH = '/'
CSRF_COOKIE_SAMESITE = 'Lax'
CSRF_COOKIE_HTTPONLY = False
CSRF_COOKIE_SECURE = config('CSRF_COOKIE_SECURE', default=False, cast=bool)  # Set to True in production with HTTPS
CSRF_COOKIE_DOMAIN = config('CSRF_COOKIE_DOMAIN', default=None)  # Set your domain in production
CSRF_COOKIE_PATH = '/'
...
# Cache configuration (using local memory cache for SQLite3)
CACHES = {
    'default': {
